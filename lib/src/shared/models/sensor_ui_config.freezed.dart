...
mixin _$SensorUiConfig {
 ...
 String? get color; String? get icon; double? get minCritical; double? get maxCritical;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,color,icon,minCritical,maxCritical);

@override
String toString() {
  return 'SensorUiConfig(color: $color, icon: $icon, minCritical: $minCritical, maxCritical: $maxCritical)';
}
...
@useResult
$Res call({
 String? color, String? icon, double? minCritical, double? maxCritical
});
...
/// Create a copy of SensorUiConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? color = freezed,Object? icon = freezed,Object? minCritical = freezed,Object? maxCritical = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? color,  String? icon,  double? minCritical,  double? maxCritical)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SensorUiConfig() when $default != null:
return $default(_that.color,_that.icon,_that.minCritical,_that.maxCritical);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? color,  String? icon,  double? minCritical,  double? maxCritical)  $default,) {final _that = this;
switch (_that) {
case _SensorUiConfig():
return $default(_that.color,_that.icon,_that.minCritical,_that.maxCritical);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? color,  String? icon,  double? minCritical,  double? maxCritical)?  $default,) {final _that = this;
switch (_that) {
case _SensorUiConfig() when $default != null:
return $default(_that.color,_that.icon,_that.minCritical,_that.maxCritical);case _:
  return null;
...
class _SensorUiConfig implements SensorUiConfig {
  const _SensorUiConfig({this.color, this.icon, this.minCritical, this.maxCritical});
...
/// Create a copy of SensorUiConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? color = freezed,Object? icon = freezed,Object? minCritical = freezed,Object? maxCritical = freezed,}) {
